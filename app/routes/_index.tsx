    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-purple-500 via-green-500 to-blue-500">
      <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-3xl shadow-2xl p-10 max-w-xl w-full">
        ...
        <div className="relative mt-8 text-white text-center border-dashed border-3 border-white-800">
          ...
          <div className="relative p-1 m-1">CF-AI状态：
          ...
          <div className="relative p-1 m-1">AI绘画模型：
             <span className={`p-1 text-center rounded-xl border-dashed border-2 border-white-800 
          ...
          <div className="relative p-1 m-1">翻译模型：
            <span className={`p-1 text-center rounded-xl border-dashed border-2 border-white-500 bg-blue-500`}>
              {configStatus.CF_TRANSLATE_MODEL}
            </span>
          </div>
          
          <div className="relative p-1 m-1">API Key：
            <span className={`p-1 text-center rounded-xl border-dashed border-2 border-white-800 
          ...
          <div className="relative p-1 m-1">CF账号：
            <span className={`p-1 text-center rounded-xl border-dashed border-2 border-white-800 
