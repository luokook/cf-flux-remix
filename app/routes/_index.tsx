    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-purple-500 via-green-500 to-blue-500">
      <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-3xl shadow-2xl p-10 max-w-xl w-full">
        ...
        <div className="mt-8 text-white justify-center text-center border-dashed border-3 border-white-800">
          ...
          <div className="flex justify-center relative m-0.5">CF-AI状态：
             <span className={`flex p-1 text-center rounded-xl border-dashed border-2 border-white-800 
                 ${cfAiStatus === "已连接" ? "bg-green-700" : "bg-red-500"}`}>
                   {cfAiStatus}
              </span>
          </div>
          
          <div className="flex justify-center relative m-0.5">AI绘画模型：
             <span className={`flex p-1 text-center rounded-xl border-dashed border-2 border-white-800 
          ...
          <div className="flex justify-center relative m-0.5">翻译模型：
            <span className={`flex p-1 text-center rounded-xl border-dashed border-2 border-white-500 bg-blue-500`}>
              {configStatus.CF_TRANSLATE_MODEL}
            </span>
          </div>
          
          <div className="flex justify-center relative m-0.5">API Key：
            <span className={`flex p-1 text-center rounded-xl border-dashed border-2 border-white-800 
          ...
          <div className="flex justify-center relative m-0.5">CF账号：
            <span className={`flex p-1 text-center rounded-xl border-dashed border-2 border-white-800 
