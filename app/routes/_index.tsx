        ...
        <div className="mt-8 text-white text-center border-dashed border-3 border-white-800">
          ...
          <p>CF-AI状态：
             <span className={`p-1 m-1 text-center rounded-xl border-dashed border-2 border-white-800 
                 ${cfAiStatus === "已连接" ? "bg-green-500" : "bg-red-500"}`}>
                   {cfAiStatus}
              </span>
          </p>
          ...
          <p>AI绘画模型：
             <span className={`p-1 m-1 text-center rounded-xl border-dashed border-2 border-white-800 
                 ${configStatus.CUSTOMER_MODEL_MAP === "已设置" ? "bg-green-500" : "bg-red-500"}`}>
          ...
          <p>API Key：
            <span className={`p-1 m-1 text-center rounded-xl border-dashed border-2 border-white-800 
                 ${configStatus.API_KEY === "已设置" ? "bg-green-500" : "bg-red-500"}`}>
          ...
          <p>CF账号：
            <span className={`p-1 m-1 text-center rounded-xl border-dashed border-2 border-white-800 
                 ${configStatus.CF_ACCOUNT_LIST === "已设置" ? "bg-green-500" : "bg-red-500"}`}>
