        ...
        <Form method="post" className="relative space-y-8" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col sm:flex-row justify-between space-y-4 sm:space-y-0">
            <button
              ...
              className={`flex px-5 py-3 mx-2 shadow-xl border-dashed border-2 border-white-800 rounded-xl text-lg font-semibold text-white transition transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-green-400
            ...
            <button
              type="submit"
              className={`flex px-5 py-3 mx-2 shadow-xl text-lg font-bold text-white transition transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-400
            ...
            <button
              type="button"
              onClick={handleReset}
              className="flex px-5 py-3 mx-2 rounded-xl border-dashed border-2 border-white-800 text-lg font-semibold text-white bg-gradient-to-r from-yellow-500 to-yellow-800 transition transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-yellow-400 shadow-xl"
              disabled={isSubmitting}
            >
              重置输入
            </button>
