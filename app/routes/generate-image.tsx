      ...
      <div className="relative bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-3xl shadow-2xl p-10 max-w-3xl w-full">
        ...
        <Form method="post" className="relative space-y-8" onSubmit={handleSubmit}>
          ...
          <textarea
              ...
              value={prompt}
              onChange={handlePromptChange}
              className="w-full text-4xl px-5 py-3 rounded-xl border border-transparent focus:outline-none focus:ring-2 focus:ring-indigo-400 bg-white bg-opacity-20 text-pretty font-bold text-white text-2xl placeholder-white placeholder-opacity-70 transition duration-300 ease-in-out hover:bg-opacity-30" 
              rows="5"
              placeholder="请输入您的提示词..."
              required
            ></textarea>
